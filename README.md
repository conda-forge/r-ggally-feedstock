...
Development: https://github.com/ggobi/ggally
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1179&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-ggally-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-ggally` can be installed with `conda`:
...
```
mamba install r-ggally
```

It is possible to list all of the versions of `r-ggally` available on your platform with `conda`:
...
```
mamba search r-ggally --channel conda-forge
```
...
mamba repoquery search r-ggally --channel conda-forge

# List packages depending on `r-ggally`:
mamba repoquery whoneeds r-ggally --channel conda-forge

# List dependencies of `r-ggally`:
mamba repoquery depends r-ggally --channel conda-forge
```
